// Name: Cedric Mathis
// Project: Take CipherText and Decrypt into PlainText
...
public class Main {
    ...
    // Ciphertext that we will parse and Decrypt
    ...
    static void printArray()
    {
        ...
        {
            System.out.println("Letter: " + String.valueOf((char)(i + 65)) +" Occurs: " + frequency[i] + " Times");
        }
    }
    ...
    public static void main(String [] args) {
        for (char cipherChar : cipherText.toCharArray())
            ...
            {
                // only letters are encrypted, punctuation marks and whitespace are not
